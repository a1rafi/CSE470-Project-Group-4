        ...
        <div>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            _id && !contact && (
                ...
                className='w-full bg-orange-700 text-white rounded-md uppercase hover:opacity-75 p-3'>Contact landlord
                </button>
            )}
            {contact && <Contact listing={listing}/>}
              ...
              {currentUser && listing.userRef !== currentUser._id && (
                ...
                reserveData.length > 0 && reserveData[0].listingRef === listingId ? (
                  <p className='w-full bg-green-400 text-black rounded-md text-center uppercase p-3'>YOU {reserveData[0].type} THIS</p>
                ) :(
...
//             _id && (
//                 <button 
//                 className='w-full bg-pink-700 text-white rounded-md uppercase hover:opacity-75 p-3'>
//                   Reserve
//                 </button>)}
//               </Link>
